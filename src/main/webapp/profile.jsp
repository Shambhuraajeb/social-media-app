							...
							<div class="container">
								<div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
									...
									<div class="card"
										...
										if (base64Image == "logo/noposts.png") {
										%>
										<img src="logo/noposts.png" width="100%" height="100%"
				...
				<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col">
							...
							%>
							<b><a href="Profile?id=<%=fri_id%>"
								style="text-decoration: none;"><%=rs4.getString(2) + " " + rs4.getString(3)%></a></b>
							<%
							if (!areFriends) {
							%>
